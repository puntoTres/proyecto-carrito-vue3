...
//Los props no requiren importarse
const props = defineProps({
    carrito: {//llamamos al prop con el mismo nombre que el padre
        type: Array,//definimos el tipo de dato
        required: true//Lo ponemos requerido.
    }
});

defineEmits(['modCarrito']);
                                    ...
                                    <tbody>
                                        <tr v-for="producto in carrito">
                                            <td>
                                                ...
                                                <img class="img-fluid" :src="'../../public/img/'+producto.imagen+'.jpg'" :alt="'imagen guitarra'+producto.nombre" >
                                            </td>
                                            ...
                                            <td class="flex align-items-start gap-4">
                                                <button
                                                    type="button"
                                                    class="btn btn-dark"
                                                    @click="$emit('modCarrito',producto)"
                                                >
                                                    -
                                                </button>
                                                {{ producto.cantidad }}
